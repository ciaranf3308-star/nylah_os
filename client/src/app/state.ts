...
export function useAppState() {
  ...
  useEffect(()=>{
    // v144 build marker
    try{ localStorage.setItem("couple_v1_build","v204-true-multiplayer-pin-audit"); }catch{}
    try{ (window as any).__NYLAH_VERSION__ = "v204-true-multiplayer-pin-audit"; }catch{}
  },[]);
