...
export function App() {
  ...
  // pull-to-refresh removed v220 to rescue scrolling — native window scroll only
  ...
  return (
    <>
      ...
      <div className={standalone ? "relative w-full max-w-[100vw] min-h-screen flex flex-col border-0 rounded-none" : "relative mx-auto w-full max-w-[390px] min-h-screen flex flex-col border-0"} style={{ background: (safeTheme as any).bg || (theme as any)?.bg, width: standalone ? "100vw" : undefined, maxWidth: standalone ? "100vw" : undefined } as any}>
        {pushToast && (
        ...
        <div ref={safePhoneInnerRef} className={standalone ? "relative flex flex-col w-full max-w-[100vw] rounded-none flex-1" : "relative flex flex-col w-full rounded-[28px] flex-1"}>
          ...
          <div className="w-full px-4 pt-3 pb-[132px]" style={{ background: (safeTheme as any).bg || (theme as any)?.bg }}>
