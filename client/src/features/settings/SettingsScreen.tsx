...
export function SettingsScreen(props: any = {}) {
  ...
  const [build, setBuild] = useState<string>("v195-shop-edge-to-edge");
  ...
  useEffect(() => {
    ...
    try {
      const v = (localStorage.getItem("couple_v1_build") || (window as any).__NYLAH_VERSION__ || "v195-shop-edge-to-edge");
