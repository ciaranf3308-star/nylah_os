...
export function SettingsScreen(props: any = {}) {
  ...
  const [build, setBuild] = useState<string>("v191-shop-boutique-lift");
  ...
  useEffect(() => {
    ...
    try {
      const v = (localStorage.getItem("couple_v1_build") || (window as any).__NYLAH_VERSION__ || "v191-shop-boutique-lift");
