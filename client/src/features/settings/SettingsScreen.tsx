...
export function SettingsScreen(props: any = {}) {
  ...
  const [build, setBuild] = useState<string>("v188-chore-create-true-live");
  ...
  useEffect(() => {
    ...
    try {
      const v = (localStorage.getItem("couple_v1_build") || (window as any).__NYLAH_VERSION__ || "v188-chore-create-true-live");
