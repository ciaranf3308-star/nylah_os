...
export function SettingsScreen(props: any = {}) {
  ...
  const [build, setBuild] = useState<string>("v202-chores-planner-delete");
  ...
  useEffect(() => {
    ...
    try {
      const v = (localStorage.getItem("couple_v1_build") || (window as any).__NYLAH_VERSION__ || "v202-chores-planner-delete");
